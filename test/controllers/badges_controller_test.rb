...
class BadgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create badge" do
    assert_difference('Badge.count') do
      post badges_url, params: { badge: { enddate: @badge.enddate, member_id: @badge.member_id, number: @badge.number, startdate: @badge.startdate, user_id: @badge.user_id } }
    end
  ...
  test "should update badge" do
    patch badge_url(@badge), params: { badge: { enddate: @badge.enddate, member_id: @badge.member_id, number: @badge.number, startdate: @badge.startdate, user_id: @badge.user_id } }
