...
class RatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rate" do
    assert_difference('Rate.count') do
      post rates_url, params: { rate: { description: @rate.description, user_id: @rate.user_id, value: @rate.value } }
    end
  ...
  test "should update rate" do
    patch rate_url(@rate), params: { rate: { description: @rate.description, user_id: @rate.user_id, value: @rate.value } }
