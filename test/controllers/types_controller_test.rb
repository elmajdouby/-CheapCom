...
class TypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post types_url, params: { type: { enddate: @type.enddate, label: @type.label, startdate: @type.startdate, user_id: @type.user_id, value: @type.value } }
    end
  ...
  test "should update type" do
    patch type_url(@type), params: { type: { enddate: @type.enddate, label: @type.label, startdate: @type.startdate, user_id: @type.user_id, value: @type.value } }
